<header>
  ...
  <div id="header_image_container" class="cycle-slideshow" data-cycle-slides="> div">
    <?php
    // The Query
    $the_header_image = new WP_Query( array( 'post_type' => 'headers', 'image_category' => 'general', 'orderby' => 'rand', 'posts_per_page' => 3 ));
    // The Loop
